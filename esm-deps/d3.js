...
// node_modules/d3/node_modules/internmap/src/index.js
...
function nest(values, map5, reduce2, keys) {
  return function regroup(values2, i) {
    ...
    for (const value of values2) {
      const key = keyof3(value, ++index3, values2);
...
function bin_default() {
  ...
  function histogram(data) {
    ...
    var i, n = data.length, x4, values = new Array(n);
    for (i = 0; i < n; ++i) {
    ...
    if (!Array.isArray(tz)) {
      ...
      if (tz[tz.length - 1] >= x12) {
        if (max7 >= x12 && domain === extent_default) {
...
function max(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    let index3 = -1;
    for (let value of values) {
      if ((value = valueof(value, ++index3, values)) != null && (max7 < value || max7 === void 0 && value >= value)) {
        max7 = value;
      }
    }
  }
...
function quickselect(array4, k2, left2 = 0, right2 = array4.length - 1, compare = ascending_default) {
  while (right2 > left2) {
    if (right2 - left2 > 600) {
...
function freedmanDiaconis_default(values, min5, max7) {
  return Math.ceil((max7 - min5) / (2 * (quantile(values, 0.75) - quantile(values, 0.25)) * Math.pow(count(values), -1 / 3)));
}

// node_modules/d3/node_modules/d3-array/src/threshold/scott.js
function scott_default(values, min5, max7) {
  return Math.ceil((max7 - min5) / (3.5 * deviation(values) * Math.pow(count(values), -1 / 3)));
}
...
function greatest(values, compare = ascending_default) {
  ...
  if (compare.length === 1) {
    ...
    for (const value of values) {
      if (defined ? compare(value, max7) > 0 : compare(value, value) === 0) {
        max7 = value;
        defined = true;
      }
    }
...
function greatestIndex(values, compare = ascending_default) {
  ...
  for (const value of values) {
    ++index3;
    if (max7 < 0 ? compare(value, value) === 0 : compare(value, maxValue) > 0) {
      maxValue = value;
      max7 = index3;
    }
  }
...
function axis(orient, scale2) {
  ...
  function axis2(context) {
    var values = tickValues == null ? scale2.ticks ? scale2.ticks.apply(scale2, tickArguments) : scale2.domain() : tickValues, format3 = tickFormat2 == null ? scale2.tickFormat ? scale2.tickFormat.apply(scale2, tickArguments) : identity_default2 : tickFormat2, spacing = Math.max(tickSizeInner, 0) + tickPadding, range3 = scale2.range(), range0 = +range3[0] + offset, range1 = +range3[range3.length - 1] + offset, position = (scale2.bandwidth ? center : number)(scale2.copy(), offset), selection2 = context.selection ? context.selection() : context, path2 = selection2.selectAll(".domain").data([null]), tick = selection2.selectAll(".tick").data(values, scale2).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
...
function hslConvert(o) {
  ...
  if (o instanceof Hsl)
    return o;
  o = o.rgb();
  var r = o.r / 255, g = o.g / 255, b = o.b / 255, min5 = Math.min(r, g, b), max7 = Math.max(r, g, b), h = NaN, s2 = max7 - min5, l = (max7 + min5) / 2;
  if (s2) {
    if (r === max7)
      h = (g - b) / s2 + (g < b) * 6;
    else if (g === max7)
      ...
      h = (r - g) / s2 + 4;
    s2 /= l < 0.5 ? max7 + min5 : 2 - max7 - min5;
    h *= 60;
  } else {
    s2 = l > 0 && l < 1 ? 0 : h;
  }
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  return function(a3, b) {
    ...
    scale2(a3.scaleX, a3.scaleY, b.scaleX, b.scaleY, s2, q);
    a3 = b = null;
    return function(t) {
...
var elasticIn = function custom7(a3, p) {
  var s2 = Math.asin(1 / (a3 = Math.max(1, a3))) * (p /= tau);
  function elasticIn2(t) {
    return a3 * tpmt(- --t) * Math.sin((s2 - t) / p);
  }
...
var elasticOut = function custom8(a3, p) {
  ...
  function elasticOut2(t) {
    return 1 - a3 * tpmt(t = +t) * Math.sin((t + s2) / p);
  }
...
var elasticInOut = function custom9(a3, p) {
  ...
  function elasticInOut2(t) {
    return ((t = t * 2 - 1) < 0 ? a3 * tpmt(-t) * Math.sin((s2 - t) / p) : 2 - a3 * tpmt(t) * Math.sin((s2 + t) / p)) / 2;
  }
...
var e22 = Math.sqrt(2);
function ticks_default2(start2, stop, count4) {
  var reverse2, i = -1, n, ticks, step;
  stop = +stop, start2 = +start2, count4 = +count4;
  if (start2 === stop && count4 > 0)
    return [start2];
  if (reverse2 = stop < start2)
    n = start2, start2 = stop, stop = n;
  if ((step = tickIncrement2(start2, stop, count4)) === 0 || !isFinite(step))
    return [];
  if (step > 0) {
    let r0 = Math.round(start2 / step), r1 = Math.round(stop / step);
    if (r0 * step < start2)
...
function tickStep2(start2, stop, count4) {
  var step0 = Math.abs(stop - start2) / Math.max(0, count4), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
  if (error >= e102)
    step1 *= 10;
  else if (error >= e52)
...
function sturges_default2(values) {
...
function contours_default() {
  var dx = 1, dy = 1, threshold2 = sturges_default2, smooth = smoothLinear;
  function contours(values) {
    var tz = threshold2(values);
    if (!Array.isArray(tz)) {
      const e = extent_default2(values), ts = tickStep2(e[0], e[1], tz);
      tz = ticks_default2(Math.floor(e[0] / ts) * ts, Math.floor(e[1] / ts - 1) * ts, tz);
    } else {
  ...
  function isorings(values, value, callback) {
    var fragmentByStart = new Array(), fragmentByEnd = new Array(), x4, y4, t04, t14, t22, t32;
    x4 = y4 = -1;
    t14 = values[0] >= value;
    cases[t14 << 1].forEach(stitch);
    while (++x4 < dx - 1) {
      t04 = t14, t14 = values[x4 + 1] >= value;
      cases[t04 | t14 << 1].forEach(stitch);
    }
    cases[t14 << 0].forEach(stitch);
    while (++y4 < dy - 1) {
      x4 = -1;
      t14 = values[y4 * dx + dx] >= value;
      t22 = values[y4 * dx] >= value;
      cases[t14 << 1 | t22 << 2].forEach(stitch);
      while (++x4 < dx - 1) {
        t04 = t14, t14 = values[y4 * dx + dx + x4 + 1] >= value;
        t32 = t22, t22 = values[y4 * dx + x4 + 1] >= value;
        cases[t04 | t14 << 1 | t22 << 2 | t32 << 3].forEach(stitch);
      }
      cases[t14 | t22 << 3].forEach(stitch);
    }
    x4 = -1;
    t22 = values[y4 * dx] >= value;
  ...
  contours.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default7(slice3.call(_)) : constant_default7(_), contours) : threshold2;
  };
...
function blurX(source, target, r) {
  var n = source.width, m2 = source.height, w = (r << 1) + 1;
  for (var j = 0; j < m2; ++j) {
  ...
  for (var i = 0; i < n; ++i) {
    for (var j = 0, sr = 0; j < m2 + r; ++j) {
      ...
      if (j >= r) {
        ...
        target.data[i + (j - r) * n] = sr / Math.min(j + 1, m2 - 1 + w - j, w);
      }
    }
  }
}
...
function density_default() {
  var x4 = defaultX, y4 = defaultY, weight = defaultWeight, dx = 960, dy = 500, r = 20, k2 = 2, o = r * 3, n = dx + o * 2 >> k2, m2 = dy + o * 2 >> k2, threshold2 = constant_default7(20);
  function density(data) {
    var values0 = new Float32Array(n * m2), values1 = new Float32Array(n * m2), pow2k = Math.pow(2, -k2);
    data.forEach(function(d, i, data2) {
      var xi = (x4(d, i, data2) + o) * pow2k, yi = (y4(d, i, data2) + o) * pow2k, wi = +weight(d, i, data2);
    ...
    blurX({ width: n, height: m2, data: values0 }, { width: n, height: m2, data: values1 }, r >> k2);
    blurY({ width: n, height: m2, data: values1 }, { width: n, height: m2, data: values0 }, r >> k2);
    blurX({ width: n, height: m2, data: values0 }, { width: n, height: m2, data: values1 }, r >> k2);
    blurY({ width: n, height: m2, data: values1 }, { width: n, height: m2, data: values0 }, r >> k2);
    blurX({ width: n, height: m2, data: values0 }, { width: n, height: m2, data: values1 }, r >> k2);
    blurY({ width: n, height: m2, data: values1 }, { width: n, height: m2, data: values0 }, r >> k2);
    ...
    if (!Array.isArray(tz)) {
      var stop = max4(values0);
      tz = tickStep2(0, stop, tz);
      tz = range_default2(0, Math.floor(stop / tz) * tz, tz);
      tz.shift();
    }
    return contours_default().thresholds(tz).size([n, m2])(values0).map(transform2);
  }
  ...
  density.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default7(slice3.call(_)) : constant_default7(_), density) : threshold2;
  };
...
function orient2dadapt(ax, ay, bx, by, cx, cy, detsum) {
  ...
  let bvirt, c5, ahi, alo, bhi, blo, _i, _j, _0, s1, s0, t14, t04, u32;
  const acx = ax - cx;
  const bcx = bx - cx;
  const acy = ay - cy;
  const bcy = by - cy;
...
var Voronoi = class {
  ...
  _init() {
    ...
    for (let i = 0, j = 0, n = triangles.length, x4, y4; i < n; i += 3, j += 2) {
      ...
      const x13 = points[t14];
      const y13 = points[t14 + 1];
      ...
      if (Math.abs(ab4) < 1e-9) {
        ...
        a3 *= Math.sign((points[r] - x13) * ey - (points[r + 1] - y13) * ex);
        x4 = (x13 + x32) / 2 - a3 * ey;
        y4 = (y13 + y32) / 2 + a3 * ex;
      } else {
        const d = 1 / ab4;
...
function formatDate(date2) {
  var hours3 = date2.getUTCHours(), minutes3 = date2.getUTCMinutes(), seconds3 = date2.getUTCSeconds(), milliseconds3 = date2.getUTCMilliseconds();
  return isNaN(date2) ? "Invalid Date" : formatYear(date2.getUTCFullYear(), 4) + "-" + pad(date2.getUTCMonth() + 1, 2) + "-" + pad(date2.getUTCDate(), 2) + (milliseconds3 ? "T" + pad(hours3, 2) + ":" + pad(minutes3, 2) + ":" + pad(seconds3, 2) + "." + pad(milliseconds3, 3) + "Z" : seconds3 ? "T" + pad(hours3, 2) + ":" + pad(minutes3, 2) + ":" + pad(seconds3, 2) + "Z" : minutes3 || hours3 ? "T" + pad(hours3, 2) + ":" + pad(minutes3, 2) + "Z" : "");
}
...
function link_default(links) {
  var id2 = index2, strength = defaultStrength, strengths, distance = constant_default8(30), distances, nodes, count4, bias, random, iterations2 = 1;
  if (links == null)
    links = [];
  ...
  function initialize() {
    if (!nodes)
      return;
    var i, n = nodes.length, m2 = links.length, nodeById = new Map(nodes.map((d, i2) => [id2(d, i2, nodes), d])), link3;
    for (i = 0, count4 = new Array(n); i < m2; ++i) {
...
function locale_default(locale5) {
  var group2 = locale5.grouping === void 0 || locale5.thousands === void 0 ? identity_default3 : formatGroup_default(map3.call(locale5.grouping, Number), locale5.thousands + ""), currencyPrefix = locale5.currency === void 0 ? "" : locale5.currency[0] + "", currencySuffix = locale5.currency === void 0 ? "" : locale5.currency[1] + "", decimal = locale5.decimal === void 0 ? "." : locale5.decimal + "", numerals = locale5.numerals === void 0 ? identity_default3 : formatNumerals_default(map3.call(locale5.numerals, String)), percent = locale5.percent === void 0 ? "%" : locale5.percent + "", minus = locale5.minus === void 0 ? "\u2212" : locale5.minus + "", nan = locale5.nan === void 0 ? "NaN" : locale5.nan + "";
...
function centroidRingPoint(lambda, phi2) {
  lambda *= radians2, phi2 *= radians2;
  var cosPhi = cos2(phi2), x4 = cosPhi * cos2(lambda), y4 = cosPhi * sin2(lambda), z = sin2(phi2), cx = y0 * z - z0 * y4, cy = z0 * x4 - x0 * z, cz = x0 * y4 - y0 * x4, m2 = hypot(cx, cy, cz), w = asin(m2), v2 = m2 && -w / m2;
  X2.add(v2 * cx);
  Y2.add(v2 * cy);
  Z2.add(v2 * cz);
  W1 += w;
...
function circleStream(stream, radius, delta, direction, t04, t14) {
  ...
  for (var point6, t = t04; direction > 0 ? t > t14 : t < t14; t -= step) {
...
function line_default(a3, b, x06, y06, x12, y12) {
  var ax = a3[0], ay = a3[1], bx = b[0], by = b[1], t04 = 0, t14 = 1, dx = bx - ax, dy = by - ay, r;
  r = x06 - ax;
  if (!dx && r > 0)
    return;
  r /= dx;
...
function graticuleX(y06, y12, dy) {
  var y4 = range_default(y06, y12 - epsilon7, dy).concat(y12);
  return function(x4) {
...
function graticuleY(x06, x12, dx) {
  var x4 = range_default(x06, x12 - epsilon7, dx).concat(x12);
  return function(y4) {
...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b02, c0, x12, y12, lambda12, a1, b12, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a3 = a0 + a1, b = b02 + b12, c5 = c0 + c1, m2 = sqrt(a3 * a3 + b * b + c5 * c5), phi2 = asin(c5 /= m2), lambda22 = abs3(abs3(c5) - 1) < epsilon7 || abs3(lambda04 - lambda12) < epsilon7 ? (lambda04 + lambda12) / 2 : atan2(b, a3), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
...
function projectionMutator(projectAt) {
  var project, k2 = 150, x4 = 480, y4 = 250, lambda = 0, phi2 = 0, deltaLambda = 0, deltaPhi = 0, deltaGamma = 0, rotate, alpha = 0, sx = 1, sy = 1, theta = null, preclip = antimeridian_default, x06 = null, y06, x12, y12, postclip = identity_default4, delta2 = 0.5, projectResample, projectTransform, projectRotateTransform, cache, cacheStream;
...
function conicEqualAreaRaw(y06, y12) {
  ...
  project.invert = function(x4, y4) {
    ...
    return [l / n, asin((c5 - (x4 * x4 + r0y * r0y) * n * n) / (2 * n))];
  };
  return project;
}
...
function azimuthalInvert(angle2) {
  return function(x4, y4) {
    var z = sqrt(x4 * x4 + y4 * y4), c5 = angle2(z), sc = sin2(c5), cc2 = cos2(c5);
    return [
      atan2(x4 * sc, z * cc2),
      asin(z && y4 * sc / z)
    ];
...
function mercatorProjection(project) {
  ...
  function reclip() {
    var k2 = pi4 * scale2(), t = m2(rotation_default(m2.rotate()).invert([0, 0]));
...
function enclose_default(circles) {
  var i = 0, n = (circles = shuffle(Array.from(circles))).length, B3 = [], p, e;
  while (i < n) {
    p = circles[i];
...
function packEnclose(circles) {
  if (!(n = (circles = array_default2(circles)).length))
    return 0;
  var a3, b, c5, n, aa2, ca3, i, j, k2, sj, sk;
...
function stratify_default() {
  ...
  function stratify(data) {
    var nodes = Array.from(data), n = nodes.length, d, i, root3, parent, node, nodeId, nodeKey, nodeByKey = new Map();
    for (i = 0; i < n; ++i) {
...
function centroid_default3(polygon) {
  var i = -1, n = polygon.length, x4 = 0, y4 = 0, a3, b = polygon[n - 1], c5, k2 = 0;
  while (++i < n) {
    a3 = b;
    b = polygon[i];
...
var uniform_default = function sourceRandomUniform(source) {
  function randomUniform(min5, max7) {
    min5 = min5 == null ? 0 : +min5;
    max7 = max7 == null ? 1 : +max7;
    if (arguments.length === 1)
      max7 = min5, min5 = 0;
    else
      max7 -= min5;
    return function() {
      return source() * max7 + min5;
    };
  }
...
var int_default = function sourceRandomInt(source) {
  function randomInt(min5, max7) {
    if (arguments.length < 2)
      max7 = min5, min5 = 0;
    min5 = Math.floor(min5);
    max7 = Math.floor(max7) - min5;
    return function() {
      return Math.floor(source() * max7 + min5);
    };
  }
...
var gamma_default = function sourceRandomGamma(source) {
  ...
  function randomGamma(k2, theta) {
    ...
    return function() {
      do {
        do {
          var x4 = randomNormal(), v2 = 1 + c5 * x4;
        } while (v2 <= 0);
        v2 *= v2 * v2;
        var u4 = 1 - source();
...
// node_modules/d3-scale/node_modules/internmap/src/index.js
...
var e23 = Math.sqrt(2);
function ticks_default3(start2, stop, count4) {
  var reverse2, i = -1, n, ticks, step;
  stop = +stop, start2 = +start2, count4 = +count4;
  if (start2 === stop && count4 > 0)
    return [start2];
  if (reverse2 = stop < start2)
    n = start2, start2 = stop, stop = n;
  if ((step = tickIncrement3(start2, stop, count4)) === 0 || !isFinite(step))
    return [];
  if (step > 0) {
    let r0 = Math.round(start2 / step), r1 = Math.round(stop / step);
    if (r0 * step < start2)
...
function tickStep3(start2, stop, count4) {
  var step0 = Math.abs(stop - start2) / Math.max(0, count4), step1 = Math.pow(10, Math.floor(Math.log(step0) / Math.LN10)), error = step0 / step1;
  if (error >= e103)
    step1 *= 10;
  else if (error >= e53)
...
function quickselect2(array4, k2, left2 = 0, right2 = array4.length - 1, compare = ascending_default3) {
  while (right2 > left2) {
    if (right2 - left2 > 600) {
      const n = right2 - left2 + 1;
      const m2 = k2 - left2 + 1;
      ...
      const newLeft = Math.max(left2, Math.floor(k2 - m2 * s2 / n + sd));
      const newRight = Math.min(right2, Math.floor(k2 + (n - m2) * s2 / n + sd));
      quickselect2(array4, k2, newLeft, newRight, compare);
    }
    const t = array4[k2];
    let i = left2;
    let j = right2;
    swap3(array4, left2, k2);
    if (compare(array4[right2], t) > 0)
      swap3(array4, left2, right2);
    while (i < j) {
      swap3(array4, i, j), ++i, --j;
      while (compare(array4[i], t) < 0)
        ++i;
      while (compare(array4[j], t) > 0)
        --j;
    ...
    if (compare(array4[left2], t) === 0)
      swap3(array4, left2, j);
    else
      ++j, swap3(array4, j, right2);
    if (j <= k2)
      left2 = j + 1;
    if (k2 <= j)
      right2 = j - 1;
...
function quantile2(values, p, valueof) {
  ...
  if (p >= 1)
    return max5(values);
  var n, i = (n - 1) * p, i0 = Math.floor(i), value0 = max5(quickselect2(values, i0).subarray(0, i0 + 1)), value1 = min3(values.subarray(i0 + 1));
  return value0 + (value1 - value0) * (i - i0);
}
function quantileSorted2(values, p, valueof = number_default3) {
  if (!(n = values.length))
    return;
  if ((p = +p) <= 0 || n < 2)
    return +valueof(values[0], 0, values);
...
function range_default3(start2, stop, step) {
  start2 = +start2, stop = +stop, step = (n = arguments.length) < 2 ? (stop = start2, start2 = 0, 1) : n < 3 ? 1 : +step;
  var i = -1, n = Math.max(0, Math.ceil((stop - start2) / step)) | 0, range3 = new Array(n);
  while (++i < n) {
    range3[i] = start2 + i * step;
...
function ordinal() {
  var index3 = new InternMap2(), domain = [], range3 = [], unknown = implicit;
  function scale2(d) {
    let i = index3.get(d);
    if (i === void 0) {
      if (unknown !== implicit)
...
function band() {
  ...
  function rescale() {
    ...
    var values = range_default3(n).map(function(i) {
...
function polymap(domain, range3, interpolate) {
  ...
  return function(x4) {
    var i2 = bisect_default2(domain, x4, 1, j) - 1;
    return r[i2](d[i2](x4));
  };
}
...
function formatDecimalParts2(x4, p) {
  if ((i = (x4 = p ? x4.toExponential(p - 1) : x4.toExponential()).indexOf("e")) < 0)
    return null;
  var i, coefficient = x4.slice(0, i);
  return [
...
function formatTrim_default2(s2) {
  out:
    for (var n = s2.length, i = 1, i0 = -1, i1; i < n; ++i) {
      switch (s2[i]) {
        case ".":
...
var prefixExponent2;
function formatPrefixAuto_default2(x4, p) {
  var d = formatDecimalParts2(x4, p);
  if (!d)
    return x4 + "";
  var coefficient = d[0], exponent2 = d[1], i = exponent2 - (prefixExponent2 = Math.max(-8, Math.min(8, Math.floor(exponent2 / 3))) * 3) + 1, n = coefficient.length;
  return i === n ? coefficient : i > n ? coefficient + new Array(i - n + 1).join("0") : i > 0 ? coefficient.slice(0, i) + "." + coefficient.slice(i) : "0." + new Array(1 - i).join("0") + formatDecimalParts2(x4, Math.max(0, p + i - 1))[0];
}

// node_modules/d3-scale/node_modules/d3-format/src/formatRounded.js
function formatRounded_default2(x4, p) {
  var d = formatDecimalParts2(x4, p);
  if (!d)
    return x4 + "";
  var coefficient = d[0], exponent2 = d[1];
...
var formatTypes_default2 = {
  ...
  "g": (x4, p) => x4.toPrecision(p),
  "o": (x4) => Math.round(x4).toString(8),
  "p": (x4, p) => formatRounded_default2(x4 * 100, p),
...
function locale_default2(locale5) {
  var group2 = locale5.grouping === void 0 || locale5.thousands === void 0 ? identity_default6 : formatGroup_default2(map4.call(locale5.grouping, Number), locale5.thousands + ""), currencyPrefix = locale5.currency === void 0 ? "" : locale5.currency[0] + "", currencySuffix = locale5.currency === void 0 ? "" : locale5.currency[1] + "", decimal = locale5.decimal === void 0 ? "." : locale5.decimal + "", numerals = locale5.numerals === void 0 ? identity_default6 : formatNumerals_default2(map4.call(locale5.numerals, String)), percent = locale5.percent === void 0 ? "%" : locale5.percent + "", minus = locale5.minus === void 0 ? "\u2212" : locale5.minus + "", nan = locale5.nan === void 0 ? "NaN" : locale5.nan + "";
  function newFormat(specifier) {
  ...
  function formatPrefix3(specifier, value) {
    var f = newFormat((specifier = formatSpecifier2(specifier), specifier.type = "f", specifier)), e = Math.max(-8, Math.min(8, Math.floor(exponent_default2(value) / 3))) * 3, k2 = Math.pow(10, -e), prefix = prefixes2[8 + e / 3];
    return function(value2) {
      return f(k2 * value2) + prefix;
    };
  }
...
function precisionRound_default2(step, max7) {
  step = Math.abs(step), max7 = Math.abs(max7) - step;
  return Math.max(0, exponent_default2(max7) - exponent_default2(step)) + 1;
}

// node_modules/d3-scale/src/tickFormat.js
function tickFormat(start2, stop, count4, specifier) {
  var step = tickStep3(start2, stop, count4), precision;
...
function linearish(scale2) {
  ...
  scale2.ticks = function(count4) {
    var d = domain();
    return ticks_default3(d[0], d[d.length - 1], count4 == null ? 10 : count4);
  };
  ...
  scale2.nice = function(count4) {
    ...
    while (maxIter-- > 0) {
      step = tickIncrement3(start2, stop, count4);
      if (step === prestep) {
        d[i0] = start2;
        d[i1] = stop;
        return domain(d);
...
function loggish(transform2) {
  ...
  scale2.ticks = function(count4) {
    ...
    if (r = v2 < u4)
      i = u4, u4 = v2, v2 = i;
    var i = logs(u4), j = logs(v2), p, k2, t, n = count4 == null ? 10 : +count4, z = [];
    if (!(base % 1) && j - i < n) {
      ...
      if (z.length * 2 < n)
        z = ticks_default3(u4, v2, n);
    } else {
      z = ticks_default3(i, j, Math.min(j - i, n)).map(pows);
    }
  ...
  scale2.tickFormat = function(count4, specifier) {
    ...
    if (count4 == null)
      count4 = 10;
    var k2 = Math.max(1, base * count4 / scale2.ticks().length);
    return function(d) {
...
function quantile3() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : range3[bisect_default2(thresholds, x4)];
  }
...
function quantize() {
  ...
  function scale2(x4) {
    return x4 != null && x4 <= x4 ? range3[bisect_default2(domain, x4, 0, n)] : unknown;
  }
  function rescale() {
    var i = -1;
    domain = new Array(n);
...
function ticker(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start2, stop, count4) {
    ...
    if (i === tickIntervals.length)
      return year3.every(tickStep3(start2 / durationYear, stop / durationYear, count4));
    if (i === 0)
      return millisecond_default.every(Math.max(tickStep3(start2, stop, count4), 1));
...
function formatLocale(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i = -1, j = 0, n = specifier.length, c5, pad4, format3;
      if (!(date2 instanceof Date))
        date2 = new Date(+date2);
      while (++i < n) {
        if (specifier.charCodeAt(i) === 37) {
          string.push(specifier.slice(j, i));
          if ((pad4 = pads[c5 = specifier.charAt(++i)]) != null)
            c5 = specifier.charAt(++i);
          else
            pad4 = c5 === "e" ? " " : "0";
          if (format3 = formats2[c5])
            c5 = format3(date2, pad4);
          string.push(c5);
          j = i + 1;
        }
      }
  ...
  function parseSpecifier(d, specifier, string, j) {
    var i = 0, n = specifier.length, m2 = string.length, c5, parse;
    while (i < n) {
      if (j >= m2)
        return -1;
...
function calendar(ticks, tickInterval, year3, month3, week, day3, hour3, minute3, second3, format3) {
  ...
  function tickFormat2(date2) {
    return (second3(date2) < date2 ? formatMillisecond : minute3(date2) < date2 ? formatSecond : hour3(date2) < date2 ? formatMinute : day3(date2) < date2 ? formatHour : month3(date2) < date2 ? week(date2) < date2 ? formatDay : formatWeek : year3(date2) < date2 ? formatMonth : formatYear4)(date2);
  }
  scale2.invert = function(y4) {
  ...
  scale2.copy = function() {
    return copy(scale2, calendar(ticks, tickInterval, year3, month3, week, day3, hour3, minute3, second3, format3));
  };
  return scale2;
}
function time() {
...
function transformer3() {
  var x06 = 0, x12 = 1, t04, t14, k10, transform2, interpolator = identity2, clamp = false, unknown;
  function scale2(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : interpolator(k10 === 0 ? 0.5 : (x4 = (transform2(x4) - t04) * k10, clamp ? Math.max(0, Math.min(1, x4)) : x4));
  }
  scale2.domain = function(_) {
    return arguments.length ? ([x06, x12] = _, t04 = transform2(x06 = +x06), t14 = transform2(x12 = +x12), k10 = t04 === t14 ? 0 : 1 / (t14 - t04), scale2) : [x06, x12];
  };
  scale2.clamp = function(_) {
  ...
  return function(t) {
    transform2 = t, t04 = t(x06), t14 = t(x12), k10 = t04 === t14 ? 0 : 1 / (t14 - t04);
    return scale2;
  };
}
...
function sequentialQuantile() {
  ...
  scale2.quantiles = function(n) {
    return Array.from({ length: n + 1 }, (_, i) => quantile2(domain, i / n));
  };
  scale2.copy = function() {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t04, t14, t22, k10, k21, interpolator = identity2, transform2, clamp = false, unknown;
  function scale2(x4) {
    return isNaN(x4 = +x4) ? unknown : (x4 = 0.5 + ((x4 = +transform2(x4)) - t14) * (s2 * x4 < s2 * t14 ? k10 : k21), interpolator(clamp ? Math.max(0, Math.min(1, x4)) : x4));
  }
  scale2.domain = function(_) {
    return arguments.length ? ([x06, x12, x22] = _, t04 = transform2(x06 = +x06), t14 = transform2(x12 = +x12), t22 = transform2(x22 = +x22), k10 = t04 === t14 ? 0 : 0.5 / (t14 - t04), k21 = t14 === t22 ? 0 : 0.5 / (t22 - t14), s2 = t14 < t04 ? -1 : 1, scale2) : [x06, x12, x22];
  };
  scale2.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale2) : clamp;
  };
  ...
  return function(t) {
    transform2 = t, t04 = t(x06), t14 = t(x12), t22 = t(x22), k10 = t04 === t14 ? 0 : 0.5 / (t14 - t04), k21 = t14 === t22 ? 0 : 0.5 / (t22 - t14), s2 = t14 < t04 ? -1 : 1;
    return scale2;
  };
}
function diverging() {
...
function cornerTangents(x06, y06, x12, y12, r1, rc, cw) {
  var x01 = x06 - x12, y01 = y06 - y12, lo = (cw ? rc : -rc) / sqrt3(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x06 + ox, y11 = y06 + oy, x10 = x12 + ox, y10 = y12 + oy, x004 = (x11 + x10) / 2, y004 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D3 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt3(max6(0, r * r * d2 - D3 * D3)), cx0 = (D3 * dy - dx * d) / d2, cy0 = (-D3 * dx - dy * d) / d2, cx1 = (D3 * dy + dx * d) / d2, cy1 = (-D3 * dx + dy * d) / d2, dx0 = cx0 - x004, dy0 = cy0 - y004, dx1 = cx1 - x004, dy1 = cy1 - y004;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon8))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon8 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min4(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t04, t14;
      if (rp > epsilon8) {
      ...
      if (!(da1 > epsilon8))
        ...
        if (rc1 < rc)
          context.arc(t04.cx, t04.cy, rc1, atan22(t04.y01, t04.x01), atan22(t14.y01, t14.x01), !cw);
        else {
          context.arc(t04.cx, t04.cy, rc1, atan22(t04.y01, t04.x01), atan22(t04.y11, t04.x11), !cw);
          context.arc(0, 0, r1, atan22(t04.cy + t04.y11, t04.cx + t04.x11), atan22(t14.cy + t14.y11, t14.cx + t14.x11), !cw);
          context.arc(t14.cx, t14.cy, rc1, atan22(t14.y11, t14.x11), atan22(t14.y01, t14.x01), !cw);
        }
      } else
      ...
      if (!(r0 > epsilon8) || !(da0 > epsilon8))
        ...
        if (rc0 < rc)
          context.arc(t04.cx, t04.cy, rc0, atan22(t04.y01, t04.x01), atan22(t14.y01, t14.x01), !cw);
        else {
          context.arc(t04.cx, t04.cy, rc0, atan22(t04.y01, t04.x01), atan22(t04.y11, t04.x11), !cw);
          context.arc(0, 0, r0, atan22(t04.cy + t04.y11, t04.cx + t04.x11), atan22(t14.cy + t14.y11, t14.cx + t14.x11), cw);
          context.arc(t14.cx, t14.cy, rc0, atan22(t14.y11, t14.x11), atan22(t14.y01, t14.x01), !cw);
        }
      } else
...
function pie_default() {
  var value = identity_default7, sortValues = descending_default2, sort2 = null, startAngle = constant_default11(0), endAngle = constant_default11(tau6), padAngle = constant_default11(0);
  function pie(data) {
...
function link2(curve) {
  ...
  function link3() {
    var buffer, argv = slice4.call(arguments), s2 = source.apply(this, argv), t = target.apply(this, argv);
    if (!context)
      context = buffer = path_default();
...
var star_default = {
  draw: function(context, size) {
    ...
    for (var i = 1; i < 5; ++i) {
      var a3 = tau6 * i / 5, c5 = Math.cos(a3), s2 = Math.sin(a3);
      context.lineTo(s2 * r, -c5 * r);
      context.lineTo(c5 * x4 - s2 * y4, s2 * x4 + c5 * y4);
    }
    context.closePath();
  }
};
...
var wye_default = {
  draw: function(context, size) {
    ...
    context.lineTo(c4 * x06 - s * y06, s * x06 + c4 * y06);
    context.lineTo(c4 * x12 - s * y12, s * x12 + c4 * y12);
    context.lineTo(c4 * x22 - s * y22, s * x22 + c4 * y22);
    context.lineTo(c4 * x06 + s * y06, c4 * y06 - s * x06);
    context.lineTo(c4 * x12 + s * y12, c4 * y12 - s * x12);
    context.lineTo(c4 * x22 + s * y22, c4 * y22 - s * x22);
    context.closePath();
  }
};
...
function point5(that, t04, t14) {
  ...
  that._context.bezierCurveTo(x06 + dx, y06 + dx * t04, x12 - dx, y12 - dx * t14, x12, y12);
}
...
function controlPoints(x4) {
  var i, n = x4.length - 1, m2, a3 = new Array(n), b = new Array(n), r = new Array(n);
  a3[0] = 0, b[0] = 2, r[0] = x4[0] + 2 * x4[1];
  for (i = 1; i < n - 1; ++i)
    a3[i] = 1, b[i] = 4, r[i] = 4 * x4[i] + 2 * x4[i + 1];
  a3[n - 1] = 2, b[n - 1] = 7, r[n - 1] = 8 * x4[n - 1] + x4[n];
  for (i = 1; i < n; ++i)
...
var day2 = newInterval2((date2) => date2.setHours(0, 0, 0, 0), (date2, step) => date2.setDate(date2.getDate() + step), (start2, end) => (end - start2 - (end.getTimezoneOffset() - start2.getTimezoneOffset()) * durationMinute2) / durationDay2, (date2) => date2.getDate() - 1);
...
function ticker2(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start2, stop, count4) {
    ...
    if (i === tickIntervals.length)
      return year3.every(tickStep(start2 / durationYear2, stop / durationYear2, count4));
    if (i === 0)
      return millisecond_default2.every(Math.max(tickStep(start2, stop, count4), 1));
    const [t, step] = tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i];
    return t.every(step);
  }
  return [ticks, tickInterval];
...
function formatLocale2(locale5) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      ...
      while (++i < n) {
        if (specifier.charCodeAt(i) === 37) {
          string.push(specifier.slice(j, i));
          if ((pad4 = pads2[c5 = specifier.charAt(++i)]) != null)
            c5 = specifier.charAt(++i);
          else
            pad4 = c5 === "e" ? " " : "0";
          if (format3 = formats2[c5])
  ...
  function parseSpecifier(d, specifier, string, j) {
    ...
    while (i < n) {
      ...
      if (c5 === 37) {
        c5 = specifier.charAt(i++);
        parse = parses[c5 in pads2 ? specifier.charAt(i++) : c5];
        if (!parse || (j = parse(d, string, j)) < 0)
          return -1;
      } else if (c5 != string.charCodeAt(j++)) {
        return -1;
...
function formatDayOfYear2(d, p) {
  return pad3(1 + day_default2.count(year_default2(d), d), p, 3);
}
...
function formatWeekNumberSunday2(d, p) {
  return pad3(sunday2.count(year_default2(d) - 1, d), p, 2);
}
function dISO2(d) {
  var day3 = d.getDay();
...
function formatWeekNumberISO2(d, p) {
  d = dISO2(d);
  return pad3(thursday2.count(year_default2(d), d) + (year_default2(d).getDay() === 4), p, 2);
}
function formatWeekdayNumberSunday2(d) {
  return d.getDay();
}
function formatWeekNumberMonday2(d, p) {
  return pad3(monday2.count(year_default2(d) - 1, d), p, 2);
}
...
function formatUTCDayOfYear2(d, p) {
  return pad3(1 + utcDay_default2.count(utcYear_default2(d), d), p, 3);
}
...
function formatUTCWeekNumberSunday2(d, p) {
  return pad3(utcSunday2.count(utcYear_default2(d) - 1, d), p, 2);
}
function UTCdISO2(d) {
  var day3 = d.getUTCDay();
...
function formatUTCWeekNumberISO2(d, p) {
  d = UTCdISO2(d);
  return pad3(utcThursday2.count(utcYear_default2(d), d) + (utcYear_default2(d).getUTCDay() === 4), p, 2);
}
function formatUTCWeekdayNumberSunday2(d) {
  return d.getUTCDay();
}
function formatUTCWeekNumberMonday2(d, p) {
  return pad3(utcMonday2.count(utcYear_default2(d) - 1, d), p, 2);
}
...
var formatIso = Date.prototype.toISOString ? formatIsoNative : utcFormat2(isoSpecifier);
...
var parseIso = +new Date("2000-01-01T00:00:00.000Z") ? parseIsoNative : utcParse2(isoSpecifier);
...
function zoom_default2() {
  ...
  zoom.scaleTo = function(selection2, k2, p, event) {
    zoom.transform(selection2, function() {
      var e = extent.apply(this, arguments), t04 = this.__zoom, p02 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t04.invert(p02), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
      return constrain(translate(scale2(t04, k1), p02, p1), e, translateExtent);
    }, p, event);
  };
  ...
  zoom.translateTo = function(selection2, x4, y4, p, event) {
    zoom.transform(selection2, function() {
      ...
      return constrain(identity4.translate(p02[0], p02[1]).scale(t.k).translate(typeof x4 === "function" ? -x4.apply(this, arguments) : -x4, typeof y4 === "function" ? -y4.apply(this, arguments) : -y4), e, translateExtent);
    }, p, event);
  };
  ...
  function dblclicked(event, ...args) {
    if (!filter3.apply(this, arguments))
      return;
    var t04 = this.__zoom, p02 = pointer_default(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t04.invert(p02), k1 = t04.k * (event.shiftKey ? 0.5 : 2), t14 = constrain(translate(scale2(t04, k1), p02, p1), extent.apply(this, args), translateExtent);
    noevent_default3(event);
    if (duration > 0)
      select_default2(this).transition().duration(duration).call(schedule, t14, p02, event);
    else
      select_default2(this).call(zoom.transform, t14, p02, event);
  }
...
export {
  ...
  extent_default4 as geoClipExtent,
  ...
  ascending_default4 as stackOrderAscending,
  ...
  day_default2 as timeDay,
  days2 as timeDays,
  timeFormat2 as timeFormat,
  defaultLocale4 as timeFormatDefaultLocale,
  formatLocale2 as timeFormatLocale,
  friday2 as timeFriday,
  fridays2 as timeFridays,
  hour_default2 as timeHour,
  hours2 as timeHours,
  newInterval2 as timeInterval,
  millisecond_default2 as timeMillisecond,
  milliseconds2 as timeMilliseconds,
  minute_default2 as timeMinute,
  minutes2 as timeMinutes,
  monday2 as timeMonday,
  mondays2 as timeMondays,
  month_default2 as timeMonth,
  months2 as timeMonths,
  timeParse2 as timeParse,
  saturday2 as timeSaturday,
  saturdays2 as timeSaturdays,
  second_default2 as timeSecond,
  seconds2 as timeSeconds,
  sunday2 as timeSunday,
  sundays2 as timeSundays,
  thursday2 as timeThursday,
  thursdays2 as timeThursdays,
  timeTickInterval2 as timeTickInterval,
  timeTicks2 as timeTicks,
  tuesday2 as timeTuesday,
  tuesdays2 as timeTuesdays,
  wednesday2 as timeWednesday,
  wednesdays2 as timeWednesdays,
  sunday2 as timeWeek,
  sundays2 as timeWeeks,
  year_default2 as timeYear,
  years2 as timeYears,
  ...
  tsvParseRows,
  union,
  utcDay_default2 as utcDay,
  utcDays2 as utcDays,
  utcFormat2 as utcFormat,
  utcFriday2 as utcFriday,
  utcFridays2 as utcFridays,
  utcHour_default2 as utcHour,
  utcHours2 as utcHours,
  millisecond_default2 as utcMillisecond,
  milliseconds2 as utcMilliseconds,
  utcMinute_default2 as utcMinute,
  utcMinutes2 as utcMinutes,
  utcMonday2 as utcMonday,
  utcMondays2 as utcMondays,
  utcMonth_default2 as utcMonth,
  utcMonths2 as utcMonths,
  utcParse2 as utcParse,
  utcSaturday2 as utcSaturday,
  utcSaturdays2 as utcSaturdays,
  second_default2 as utcSecond,
  seconds2 as utcSeconds,
  utcSunday2 as utcSunday,
  utcSundays2 as utcSundays,
  utcThursday2 as utcThursday,
  utcThursdays2 as utcThursdays,
  utcTickInterval2 as utcTickInterval,
  utcTicks2 as utcTicks,
  utcTuesday2 as utcTuesday,
  utcTuesdays2 as utcTuesdays,
  utcWednesday2 as utcWednesday,
  utcWednesdays2 as utcWednesdays,
  utcSunday2 as utcWeek,
  utcSundays2 as utcWeeks,
  utcYear_default2 as utcYear,
  utcYears2 as utcYears,
  variance,
